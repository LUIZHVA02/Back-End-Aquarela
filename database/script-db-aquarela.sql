...
create table tbl_usuario( 
    ...
    avaliacao float,
    usuario_status boolean not null default 1
);
...
create table tbl_seguidores ( 
    ...
    seguidores_status boolean not null default 1,
...
create table tbl_endereco( 
    ...
    cep varchar(9),
    endereco_status boolean not null default 1
);
...
create table tbl_usuario_endereco( 
    ...
    usuario_endereco_status boolean not null default 1,
...
create table tbl_postagem ( 
    ...
    id_usuario integer not null,
	postagem_status boolean not null default 1,
    foreign key (id_usuario) references tbl_usuario (id_usuario)
);
...
create table tbl_produto( 
	...
	id_usuario integer not null,
    produto_status boolean not null default 1,
	foreign key (id_usuario) references tbl_usuario (id_usuario)
);
...
create table tbl_categoria_produto (
    ...
    categoria_produto_status boolean not null default 1,
...
create table tbl_categoria_postagem (
    ...
    id_categoria integer not null,
    categoria_postagem_status boolean not null default 1,
...
create table tbl_preferencia ( 
    ...
    id_usuario integer not null,
    id_categoria integer not null,
    preferencia_status boolean not null default 1,
    foreign key (id_usuario) references tbl_usuario(id_usuario),
    foreign key (id_categoria) references tbl_categoria(id_categoria)
);
...
create table tbl_comentario ( 
	...
	id_usuario integer not null,
    id_resposta integer,
    comentario_status boolean not null default 1,
	foreign key (id_usuario) references tbl_usuario (id_usuario),
...
create table tbl_comentario_produto ( 
    ...
    comentario_produto_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto (id_produto),
...
create table tbl_comentario_postagem ( 
    ...
    id_postagem integer not null,
    id_comentario integer not null,
    comentario_postagem_status boolean not null default 1,
    foreign key (id_postagem) references tbl_postagem (id_postagem),
    foreign key (id_comentario) references tbl_comentario (id_comentario)
);
...
create table tbl_produto_favorito ( 
    ...
    id_produto integer not null,    
    id_usuario integer not null,
    produto_favorito_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto (id_produto),
    foreign key (id_usuario) references tbl_usuario (id_usuario)
);
...
create table tbl_postagem_favorita ( 
    ...
    id_postagem integer not null,
    id_usuario integer not null,
    postagem_favorita_status boolean not null default 1,
    foreign key (id_postagem) references tbl_postagem (id_postagem),
    foreign key (id_usuario) references tbl_usuario (id_usuario)
);
...
create table tbl_curtida_postagem (
    ...
    id_postagem integer not null,
    id_usuario integer not null,
    curtidas_postagem_status boolean not null default 1,
    foreign key (id_postagem) references tbl_postagem(id_postagem),
    foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_curtida_produto (
    ...
    id_produto integer not null,
    id_usuario integer not null,
    curtidas_produto_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto(id_produto),
    foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_visualizacao_produto (
    ...
    id_produto integer not null,
    id_usuario integer not null,
    visualizacao_produto_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto(id_produto),
    foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_visualizacao_postagem (
    ...
    id_postagem integer not null,
    id_usuario integer not null,
    visualizacao_postagem_status boolean not null default 1,
    foreign key (id_postagem) references tbl_postagem(id_postagem),
    foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_imagem ( 
    ...
    imagem_status boolean not null default 1
);
...
create table tbl_imagem_produto ( 
    ...
    id_produto integer not null,
    imagem_produto_status boolean not null default 1,
...
create table tbl_imagem_postagem (
    ...
    id_imagem integer not null,
    id_postagem integer not null,
    imagem_postagem_status boolean not null default 1,
    foreign key (id_imagem) references tbl_imagem(id_imagem),
    foreign key (id_postagem) references tbl_postagem(id_postagem)
);
...
create table tbl_pasta ( 
    ...
    nome varchar(100),
	id_usuario integer not null,
    pasta_status boolean not null default 1,
	foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_pasta_postagem ( 
    ...
    pasta_postagem_status boolean not null default 1,
    foreign key (id_postagem) references tbl_postagem(id_postagem),
...
create table tbl_pasta_produto (
    ...
    id_produto integer not null,
    id_pasta integer not null,
    pasta_produto_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto(id_produto),
    foreign key (id_pasta) references tbl_pasta(id_pasta)
);
...
create table tbl_carrinho_compra( 
	...
	id_usuario integer not null,
    carrinho_compra_status boolean not null default 1,
	foreign key (id_usuario) references tbl_usuario(id_usuario)
);
...
create table tbl_item_carrinho( 
    ...
    item_carrinho_status boolean not null default 1,
    foreign key (id_produto) references tbl_produto(id_produto),
...
create table tbl_pedido(
    ...
    pedido_status boolean not null default 1,
...
create table tbl_item_pedido(
    ...
    id_produto integer not null,
    item_pedido_status boolean not null default 1,
...
create table tbl_conversa(
    ...
    conversa_status boolean not null default 1,
...
create table tbl_mensagem (
    ...
    mensagem_status boolean not null default 1,
    foreign key (id_usuario) references tbl_usuario(id_usuario),
...
tipo_perfil_status boolean not null default 1
);
...
id_tipo_perfil_usuario integer not null primary key auto_increment,
    ...
    id_usuario integer not null,
tipo_perfil_usuario_status boolean not null default 1,
    foreign key (id_usuario) references tbl_usuario(id_usuario),
...
create table tbl_banco (
    ...
    banco text,
    banco_status boolean not null default 1
);
